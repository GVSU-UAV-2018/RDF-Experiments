...
antenna_data = np.genfromtxt('rad_pattern.csv', delimiter=',', skip_header=1)
...
data = np.genfromtxt('test_data.csv', delimiter=',', skip_header=1)

heading = data[:,0]
snr = 10*np.log10(data[:,3]/data[:,1])
